...
const grades = {
  ...
  2: { strand: "Reading", subStrand: "Language Patterns and Comprehension", concepts: ["describing words", "naming and action words", "present and past actions", "sentence sequencing", "reading for meaning"] },
...
function makePath(grade: Grade): CurriculumNode[] {
  ...
  return [
    { id: ids[0], grade, subject: "english", strand: g.strand, subStrand: g.subStrand, concept: g.concepts[0], title: grade <= 3 ? "Describing Words" : "Adjectives in Use", description: "Learn the idea first with examples and a guided activity.", kind: "lesson", route: "/learn/adjectives", activityId: `english-g${grade}-describing-words`, curriculumId: ids[0], xp: 20, required: true },
    ...
    { id: ids[2], grade, subject: "english", strand: g.strand, subStrand: g.subStrand, concept: g.concepts[2], title: "Independent Practice", description: "Show what you can do without the lesson steps.", kind: "independent_practice", route: "/challenge/demo-adjective-describing-word", activityId: "demo-adjective-describing-word", curriculumId: ids[2], xp: 40, required: true },
    { id: ids[3], grade, subject: "english", strand: g.strand, subStrand: g.subStrand, concept: g.concepts[3], title: "Mastery Mission", description: "Prove that you can use the skill confidently.", kind: "mastery", route: "/challenge/demo-adjective-describing-word", activityId: "demo-adjective-describing-word", curriculumId: ids[3], xp: 60, required: true },
    { id: ids[4], grade, subject: "english", strand: g.strand, subStrand: g.subStrand, concept: g.concepts[4], title: "Reading Adventure", description: "Use the skill in a meaningful reading task.", kind: "story", route: "/story", activityId: `g${grade}-reading`, curriculumId: ids[4], xp: 50, required: true },
  ];
}
