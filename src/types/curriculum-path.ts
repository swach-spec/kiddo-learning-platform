...
export type CurriculumNode = { id: string; grade: Grade; subject: "english" | "mathematics"; strand: string; subStrand: string; concept: string; title: string; description: string; kind: CurriculumNodeKind; route?: string; supportRoute?: string; activityId?: string; curriculumId: string; xp: number; required: boolean };
